...
package com.example.vendrisample;
...
import com.vendri.androidsdk.Vendri;
import com.vendri.androidsdk.VendriListener;
...
public class HelloEffects extends Activity implements GLSurfaceView.Renderer,
    ...
    static VendriListener vendriListener;
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState)
    {
        ...
        Vendri.viewRestoreState(savedInstanceState);
    }
    ...
    public void helloWorld(){
        Toast.makeText(getApplicationContext(),"Reflection called me",Toast.LENGTH_LONG).show();
    }
    ...
    public void adStarted() {
        Toast.makeText(getApplicationContext(), "Ad started", Toast.LENGTH_LONG).show();
